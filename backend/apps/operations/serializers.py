...
ProductAttributeDefinitionSerializer = serializer_for(models.ProductAttributeDefinition)
ProductAttributeValueSerializer = serializer_for(models.ProductAttributeValue)
...
ReportQueryParameterSerializer = serializer_for(models.ReportQueryParameter)
