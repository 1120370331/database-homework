...
ProductAttributeDefinitionViewSet = viewset_for(models.ProductAttributeDefinition, serializers.ProductAttributeDefinitionSerializer)
ProductAttributeValueViewSet = viewset_for(models.ProductAttributeValue, serializers.ProductAttributeValueSerializer)
...
ReportQueryParameterViewSet = viewset_for(models.ReportQueryParameter, serializers.ReportQueryParameterSerializer)
